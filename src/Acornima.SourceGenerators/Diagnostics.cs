...
internal static class Diagnostics
{
    ...
    public static readonly DiagnosticDescriptor InvalidVisitableNodeAttributeUsageWarning = new(
        ...
        messageFormat: "Class '{0}' must be non-nested, non-generic, partial and must inherit from '{1}' when it is annotated with 'Acornima.Ast.VisitableNodeAttribute'",
        category: "Design",
    ...
    public static readonly DiagnosticDescriptor InvalidAutoGeneratedAstVisitorAttributeUsageWarning = new(
        ...
        messageFormat: "Class '{0}' must be non-nested, partial and must inherit from '{1}' when it is annotated with 'Acornima.AutoGeneratedAstVisitorAttribute'",
        category: "Design",
        DiagnosticSeverity.Warning,
        isEnabledByDefault: true);
}
